...
public class Federacion implements Serializable {
        ...
        switch (PeticionDatos.pedirEnteroRango(1, 3, 3, "Dame un opcion: ")) {
            case 1 -> {
                if (EquipoBaloncesto.totalEquipos == 4) {
                    ...
                    equipos[posicion].setPartidosJugados(r1.nextInt(6,12));//Inicamos partidos Jugados
                    equipos[posicion].setPartidosGanados((r1.nextInt(4, 7)* equipos[posicion].partidosJugados/10));
                    equipos[posicion].setPartidosPerdidos(equipos[posicion].partidosJugados-equipos[posicion].partidosGanados);
            ...
            case 2 -> {
                if (EquipoFutbol.totalEquipos == 4) {
                    ...
                    equipos[posicion].setPartidosJugados(r1.nextInt(10,18));//Inicamos partidos Jugados
                    equipos[posicion].setPartidosGanados((r1.nextInt(3, 6)* equipos[posicion].partidosJugados/10));
                    ((EquipoFutbol)equipos[posicion]).setPartidosEmpatados((r1.nextInt(1, 3)* equipos[posicion].partidosJugados/10));
                    equipos[posicion].setPartidosPerdidos(equipos[posicion].partidosJugados-equipos[posicion].partidosGanados-((EquipoFutbol) equipos[posicion]).partidosEmpatados);
            ...
            case 3 -> {
                if (EquipoBalonmano.totalEquipos == 4) {
                    ...
                    equipos[posicion].setPartidosJugados(r1.nextInt(6,18));//Inicamos partidos Jugados
                    System.out.println(equipos[posicion].getPartidosJugados());
                    equipos[posicion].setPartidosGanados((r1.nextInt(5, 8)* equipos[posicion].partidosJugados/10));
                    ((EquipoBalonmano)equipos[posicion]).setPartidosEmpatados((r1.nextInt(1, 2)* equipos[posicion].partidosJugados/10));
                    equipos[posicion].setPartidosPerdidos(equipos[posicion].partidosJugados-equipos[posicion].partidosGanados-((EquipoBalonmano) equipos[posicion]).getPartidosEmpatados());
    ...
    private static void iniciarPartidos(Equipo[] equipos, int opcion) {
            ...
            case 1:
                for (int x = 0; x < Equipo.totalEquipos; x++) {
                    if (equipos[x] instanceof EquipoBaloncesto) {
                        System.out.println("\nEstadisticas " + equipos[x].nombreEquipo + ": " + (equipos[x]).valoracion()+ " "+(equipos[x]).posicion());
                    }
                }
                break;
