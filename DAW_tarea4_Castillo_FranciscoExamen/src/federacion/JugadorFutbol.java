...
/**
 * Clase de JugadorFutbol, esta es la encargada de crear un Jugador de tipo Futbol. Esta hereda de Jugador
 ...
 * @version 28/01/2022
 */
public class JugadorFutbol extends Jugador implements Estadisticas, Serializable {
    //Atributos
    ...
    @Override
    public int posicion() {
        return (partidosGanados*2)+(partidosEmpatados)+((minutosJugados / 70));
    }
