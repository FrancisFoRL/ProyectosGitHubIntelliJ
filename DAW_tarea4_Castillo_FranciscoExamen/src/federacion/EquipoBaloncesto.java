...
public class EquipoBaloncesto extends Equipo implements Estadisticas, Serializable {
    ...
    public void iniciarJugador(){
        ...
        for(int x = 0; x < jugadorBaloncesto.length; x++){
            if(jugadorBaloncesto[x] != null){
                jugadorBaloncesto[x].setPartidosJugados(this.partidosJugados);
                jugadorBaloncesto[x].setPartidosGanados(this.partidosGanados);
                jugadorBaloncesto[x].setPartidosPerdidos(this.partidosPerdidos);
                jugadorBaloncesto[x].setMinutosJugados(r1.nextInt(20,40)*partidosJugados);
            }else{
                break;
            }
        }
